                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-96 overflow-y-auto">
                      {userBots.length === 0 ? (
                        <div className={`col-span-3 p-8 text-center rounded-lg border-2 border-dashed ${darkMode ? 'border-neutral-700 text-gray-400' : 'border-gray-300 text-gray-500'}`}>
                          <div className="flex justify-center mb-3">
                            <svg className="size-10 opacity-50" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                              <path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4-6.2-4.5-6.2 4.5 2.4-7.4L2 9.4h7.6L12 2z"/>
                            </svg>
                        ...
                        userBots.map(bot => (
                          <div 
                            ...
                            className={`${darkMode ? 'bg-neutral-700 hover:bg-neutral-600 border-neutral-600' : 'bg-white hover:bg-gray-50 border-gray-200'} border rounded-lg p-4 cursor-pointer transition-colors ${selectedBot?.id === bot.id ? (darkMode ? 'ring-2 ring-blue-500' : 'ring-2 ring-blue-500') : ''}`}
                          >
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <div>
                                ...
                                <div className="flex gap-2 mt-1">
                                  ...
                                  <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getFrameworkColor('UBOS.ai')}`}>
                                    UBOS.ai
                                  </span>
                                </div>
                              </div>
